...
@else
    <form action="{{ url('/rekomendasi/' . $rekomendasi->id . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $rekomendasi->lomba->nama }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama Mahasiswa :</th>
                            <td class="col-9">{{ $rekomendasi->mahasiswa->nama_lengkap }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="text-right col-3">Skor :</th>
                            <td class="col-9">{{ $rekomendasi->skor }}</td>
                        </tr>
                        <tr>
