...
@else
    <form action="{{ url('/prestasi/' . $prestasi->id . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $prestasi->nama_prestasi }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Status Prestasi:</th>
